...
- **[Knowledge](https://github.com/fulminate-io/knowledge-mcp)** - Persistent memory for coding agents that stores hypotheses, evidence, and decisions as a queryable graph, so a new session picks up where the last one stopped.
